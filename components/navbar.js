(function () {
  ...
  const links = [["home", "Home", "Lumi.html"], ["mood", "Mood", "mood.html"], ["community", "Community", "community.html"], ["support", "Support", "get-support.html"]];
  function createNavbar(activePage = "", options = {}) {
    const isLumi = true;
    ...
    const sanaLogo = '<span class="sana-brand-mark sana-brand-symbol" aria-hidden="true"><svg viewBox="0 0 48 48"><defs><linearGradient id="sanaLogoGradient" x1="8" y1="6" x2="39" y2="42" gradientUnits="userSpaceOnUse"><stop stop-color="#78c9ff"/><stop offset=".55" stop-color="#b7b8ff"/><stop offset="1" stop-color="#ffb6d1"/></linearGradient></defs><path fill="url(#sanaLogoGradient)" d="M24 8c7.5 0 13.7 5.9 13.7 13.2S31.5 39 24 39 10.3 28.5 10.3 21.2 16.5 8 24 8Z"/><circle cx="30.7" cy="16.4" r="5.3" fill="#fff" fill-opacity=".78"/></svg></span>';
    const logo = '<img class="sana-brand-mark lumi-brand-mark" src="assets/branding/lumi-logo-placeholder.svg" alt="Lumi logo">';
    const name = '<span class="sana-brand-lockup"><span class="sana-brand-name">Lumi</span><span class="lumi-tagline">A little light for how you feel.</span></span>';
    return `<header class="sana-nav sana-shared-nav${pageClass}${isLumi ? " lumi-nav" : ""}"><a class="sana-brand" href="Lumi.html">${logo}${name}</a><nav class="sana-nav-links" aria-label="Primary navigation">${items}</nav><a href="profile.html" aria-label="Open profile"><img src="./image/lego.png" class="sana-avatar" alt="Open profile"></a></header>`;
  }
